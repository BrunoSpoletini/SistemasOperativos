...
int main(){
    ...
    */
    ...
    strncpy( server_name.sun_path , SRV_NAME, sizeof( server_name.sun_path ) );
    ...
    char *MSG = "Hi Server";
    sendto(client_socket, MSG , strlen(MSG) , 0,(struct sockaddr_un *) &server_name, sizeof( server_name ) );
